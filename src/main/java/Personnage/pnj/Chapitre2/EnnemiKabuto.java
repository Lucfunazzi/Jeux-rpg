...
public class EnnemiKabuto extends PersonnageBase {

    public EnnemiKabuto() {
        this(18);
    }

    public EnnemiKabuto(int niveau) {
        this.nom    = "Kabuto";
        this.niveau = niveau;
        this.type   = "Ninja";
        this.role   = "Support";
        ...
        this.vie     = 350.2 * mult * niv;
        this.attaque =  90.4 * mult * niv;
        this.defense =  45.2 * mult * niv;
        this.vitesse =  200.7 * mult * vit;
