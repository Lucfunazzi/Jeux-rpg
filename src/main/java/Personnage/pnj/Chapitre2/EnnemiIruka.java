...
public class EnnemiIruka extends PersonnageBase {

    public EnnemiIruka() {
        this(13);
    }

    public EnnemiIruka(int niveau) {
        this.nom    = "Iruka";
        this.niveau = niveau;
        this.type   = "Ninja";
        this.role   = "Tank";
        ...
        this.vie     = 278.4 * mult * niv;
        this.attaque =  66.8 * mult * niv;
        this.defense =  50.1 * mult * niv;
        this.vitesse =  70.1 * mult * vit;
