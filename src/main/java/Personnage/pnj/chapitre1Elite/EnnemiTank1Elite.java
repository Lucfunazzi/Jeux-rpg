...
public class EnnemiTank1Elite extends PersonnageBase {
    ...
    public EnnemiTank1Elite(int niveau) {
        ...
        this.vie     = 597.0 * niv;
        this.attaque = 111.9 * niv;
        this.defense = 167.9 * niv;
        this.vitesse =  75.4 * vit;

        this.taux_critiques    = 0.05;
        this.degat_critiques   = 1.10;
        this.taux_precisions   = 100.00;
        this.taux_esquives     = 0.10;
        this.taux_blocage      = 0.30;
    ...
    @Override public void descriptionAttaqueSpeciale() {
        System.out.println("Charge de Bouclier : inflige 140% ATK a la cible. 30% de chance d'etourdir 1 tour.");
    }
    @Override public void descriptionAttaqueUltime() {
        System.out.println("Tremblement de Terre : inflige 120% ATK a toute l'equipe ennemie et reduit leur DEF de 10% pendant 2 tours.");
    }
}