...
public class EnnemiNatsuElite extends PersonnageBase {

    public EnnemiNatsuElite() {
        this(20);
    }

    public EnnemiNatsuElite(int niveau) {
        this.nom    = "Natsu";
        this.niveau = niveau;
        this.type   = "Mage";
        this.role   = "DPS";
        ...
        this.vie     = 593.6 * niv;
        this.attaque = 138.5 * niv;
        this.defense =  79.1 * niv;
        this.vitesse = 142.6 * vit;
