...
public class EnnemiMage8DPS extends PersonnageBase {
    ...
    public EnnemiMage8DPS(Variante variante, int niveau) {
    ...
    @Override public void descriptionAttaqueUltime() {
        System.out.println("Charge Devastatrice : inflige 70% ATK a toute l'equipe ennemie.");
    }
}
