...
public class Chevalier implements Competences {
   ...
   @Override public void descriptionCompetenceArbre() {
    ...
    @Override public void descriptionCompetenceArbre5() {
        System.out.println("Lance Étoilée — Inflige 185% ATK au Tank ennemi. Inflige Malediction (soins réduits de 20%) pendant 3 tours.");
    }
    ...
    public void competenceArbre6(Personnage_principale utilisateur, PersonnageBase cible,
            List<PersonnageBase> equipeAlliee, List<PersonnageBase> equipeEnnemie, List<String> log) {
        log.add("Lance Émeraude de la Revendication !");
    ...
    @Override public void descriptionCompetenceArbre6() {
        System.out.println("Lance Émeraude de la Revendication — Inflige 130% ATK à tous les attaquants ennemis. Augmente l'attaque des attaquants alliés de 20% pendant 2 tours.");
    }
    ...
    public void competenceArbre7(Personnage_principale utilisateur, PersonnageBase cible,
            List<PersonnageBase> equipeAlliee, List<PersonnageBase> equipeEnnemie, List<String> log) {
        log.add("Lance de la Grâce Purificatrice !");
    ...
    @Override public void descriptionCompetenceArbre7() {
        System.out.println("Lance de la Grâce Purificatrice — Inflige 175% ATK au Tank ennemi et à tous les attaquants ennemis. Donne au lanceur 20% d'absorption de vie pendant 2 tours. Inflige Aveuglement (-20% précision) aux attaquants ennemis pendant 2 tours.");
    }
    ...
    public void ultimeArbre4(Personnage_principale utilisateur, List<PersonnageBase> equipeAlliee,
            List<PersonnageBase> equipeEnnemie, List<String> log) {
        log.add("Danse des Lances Anémisthe !");
    ...
    @Override public void descriptionUltimeArbre4() {
        System.out.println("Danse des Lances Anémisthe — Inflige 80% ATK à toute l'équipe ennemie. Soigne le lanceur de 10% des dégâts totaux infligés.");
    }
    ...
    public void ultimeArbre8(Personnage_principale utilisateur, List<PersonnageBase> equipeAlliee,
            List<PersonnageBase> equipeEnnemie, List<String> log) {
        log.add("Lance Explosive Chasseuse de Démons !");
        for (PersonnageBase ennemi : equipeEnnemie) {
            if (ennemi.estVivant()) {
    ...
    @Override public void descriptionUltimeArbre8() {
        System.out.println("Lance Explosive Chasseuse de Démons — Inflige 180% ATK à tous les ennemis. "
