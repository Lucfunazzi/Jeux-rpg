...
public class Invocateur implements Competences {
    ...
    public void competenceArbre5(Personnage_principale utilisateur, PersonnageBase cible,
            List<PersonnageBase> equipeAlliee, List<PersonnageBase> equipeEnnemie, List<String> log) {
        log.add("Invocation Libra : Gravity Changes !");
        PersonnageBase cibleFinale = Combat.choisirCible(utilisateur, equipeEnnemie);
    ...
    @Override public void descriptionCompetenceArbre5() {
        System.out.println("Invocation Libra : Gravity Changes — Inflige 185% ATK au Tank ennemi. Inflige Malediction (soins réduits de 20%) pendant 3 tours.");
    }
    ...
    public void competenceArbre6(Personnage_principale utilisateur, PersonnageBase cible,
            List<PersonnageBase> equipeAlliee, List<PersonnageBase> equipeEnnemie, List<String> log) {
        log.add("Invocation Taurus + Scorpion : Haches Sablées !");
    ...
    @Override public void descriptionCompetenceArbre6() {
        System.out.println("Invocation Taurus + Scorpion : Haches Sablées — Inflige 130% ATK à tous les attaquants ennemis. Augmente l'attaque des attaquants alliés de 20% pendant 2 tours.");
    }
    ...
    public void competenceArbre7(Personnage_principale utilisateur, PersonnageBase cible,
            List<PersonnageBase> equipeAlliee, List<PersonnageBase> equipeEnnemie, List<String> log) {
        log.add("Invocation Ophiuchus le Serpentaire !");
    ...
    @Override public void descriptionCompetenceArbre7() {
        System.out.println("Invocation Ophiuchus le Serpentaire — Inflige 175% ATK au Tank ennemi et à tous les attaquants ennemis. Donne au lanceur 20% d'absorption de vie pendant 2 tours. Inflige Aveuglement (-20% précision) aux attaquants ennemis pendant 2 tours.");
    }
    ...
    public void ultimeArbre4(Personnage_principale utilisateur, List<PersonnageBase> equipeAlliee,
            List<PersonnageBase> equipeEnnemie, List<String> log) {
        log.add("Invocation Leo : Regulus Punch !");
    ...
    @Override public void descriptionUltimeArbre4() {
        System.out.println("Invocation Leo : Regulus Punch — Inflige 80% ATK à toute l'équipe ennemie. Soigne le lanceur de 10% des dégâts totaux infligés.");
    }
    ...
    @Override public void descriptionUltimeArbre8() {
        System.out.println("Urano Metria — Inflige 180% ATK à tous les ennemis. "
